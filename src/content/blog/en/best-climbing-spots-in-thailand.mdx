...
excerpt: "Beaches you can only reach by longtail boat, stalactite-hung caves above the sand, and ropeless climbs that end with a splash — Thai limestone is a world of its own."
...
Thai limestone is steep, featured, and tropical. Tufas, stalactites, pockets, and the occasional sharp crimp define the climbing, which tends toward the steep and gymnastic. Humidity is the constant challenge: holds can feel greasy, and condensation affects friction, so climbers learn to chase the driest conditions and the best times of day. The bolting is generally good, but the marine environment means hardware corrodes — a problem the [UIAA](https://www.theuiaa.org/) has studied closely — and climbers should be alert to old fixed gear.
